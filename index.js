/* empty css                      */import{a as q,S as P,i as n}from"./assets/vendor-DZWlGVzj.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))l(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const s of t.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&l(s)}).observe(document,{childList:!0,subtree:!0});function o(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function l(e){if(e.ep)return;e.ep=!0;const t=o(e);fetch(e.href,t)}})();const B="https://pixabay.com/api/",M="56068284-30f7ab574d20f3e020b06a8c1";async function y(a,r){const o={key:M,q:a,image_type:"photo",orientation:"horizontal",safesearch:!0,per_page:15,page:r};return(await q.get(B,{params:o})).data}function m(a){return a.map(({webformatURL:r,largeImageURL:o,tags:l,likes:e,views:t,comments:s,downloads:S})=>`
